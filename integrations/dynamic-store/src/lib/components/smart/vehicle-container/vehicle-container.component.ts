...
export class VehicleContainerComponent implements OnInit {
  elements: DashBoardElementsItemModel | undefined;
  model$: Observable<VehicleContainerStupidModelModel> | undefined;
  view$: Observable<VehicleContainerStupidViewModel> | undefined;
  elements$: Observable<VehicleContainerElementsModel> | undefined;
    ...
    switch (event.eventType) {
      case VehicleContainerEventType.addVehicle:
        ...
        this.store.dispatchInLocation(
          new AddVehicleAppServiceAction({
